...
public Pixmap InitIconBitmap() {
   ...
   return( XCreateBitmapFromData( display, DefaultRootWindow( display ), opus_bits, opus_width, opus_height ) );
}


//public void RedrawIcon( XEvent  *exv ) {
//   XCopyPlane( display, pix.icon, iconW, gcs.black, 0, 0, opus_width, opus_height, 0, 0, 1 );
//}
...
public Window CreateIconWindow( Coord  x, Coord y ) {
   Window      icw;
