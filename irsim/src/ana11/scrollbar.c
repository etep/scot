...
private void StretchLeft  ( Coord  x );
private void StretchRight ( Coord  x );
private void MoveBar      ( Coord  x );

private void MoveLeft  ( int  hpages );
private void MoveRight ( int  hpages );

public void DrawScrollBar( int isExpose ) {
 ...
 */
public void DoScrollBar( XButtonEvent  *ev ) {
