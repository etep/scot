/*************************** TESTMXH.CPP ******************** AgF 2002-10-20 *
*                                                                            *
*  Test multivariate extended hypergeometric distribution                    *
...
void main() {
    ...
    for ( sam = 0; sam < nsamp; sam++ ) {
        ...
        // make sample
        sto.MultiExtendedHypergeo( xlist, mlist, wlist, n, colors );
    ...
    MultiExtendedHypergeometricC mxh( n, mlist, wlist, colors, 1E-10f );
    mxh.mean( mu1 );
    mxh.variance( var1 );
